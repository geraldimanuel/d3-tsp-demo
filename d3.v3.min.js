d3 = (function () {
	...
	function S(n) {
		...
		return function (e, r) {
			...
			r
				? ((t.lastIndex = 0),
				  t.test(u) || e.setAttribute("class", x(u + " " + n)))
	...
	function N(n) {
		return (
			arguments.length || (n = ca.ascending),
			function (t, e) {
	...
	function K(n, t, e) {
		...
		return (
			...
			(i = Q(i) * Va),
			et(
				tt(3.2404542 * u - 1.5371385 * r - 0.4985314 * i),
				tt(-0.969266 * u + 1.8760108 * r + 0.041556 * i),
				tt(0.0556434 * u - 0.2040259 * r + 1.0572252 * i)
			)
		);
	}
	function W(n, t, e) {
	...
	function dt() {
		for (var n = null, t = Wa, e = 1 / 0; t; )
			t.flush
				? (delete Ka[t.callback.id],
				  (t = n ? (n.next = t.next) : (Wa = t.next)))
	...
	function Ut(n, t) {
		...
		for (
			...
			(o = n[i]),
				...
				(u = 1 - t * Math.cos(c) * f),
				(Math.abs(h - 2) < Ha && Math.abs(u - 2) < Ha) ||
					(Math.abs(u) < Ha ||
						Math.abs(h) < Ha ||
						(Math.abs(Math.abs(r - s) - Fa) < Ha
							? u + h > 2 && (a += 4 * (r - s))
							: (a +=
									Math.abs(h - 2) < Ha
										? 4 * (r - g)
										: (((3 * Fa + r - s) % (2 * Fa)) - Fa) * (h + u))),
					(g = s),
					(s = r),
					(h = u));
		return a;
	...
	function It(n, t) {
		return (
			((n = n.point)[0] < 0 ? n[1] - Fa / 2 - Ha : Fa / 2 - n[1]) -
			...
			var y,
				...
				C = {
					...
					polygonEnd: function () {
						(c = N),
							(y = ca.merge(y)).length
								? (c.polygonStart(), Ht(y, i, l, h, c), c.polygonEnd())
								: f([n, t]) &&
								  (c.polygonStart(),
								  c.lineStart(),
								  h(null, null, 1, c),
	...
	function ze(n) {
		...
		return (
			...
			(t.interpolate = function (n) {
				return arguments.length
					? ((a = "function" == typeof n ? (i = n) : (i = jo.get(n) || Le).key),
					  t)
					: a;
			}),
		...
		return (
			o[0] != c[0] || o[1] != c[1]
				? (r.push("translate(", null, ",", null, ")"),
				  u.push({ i: 1, x: gr(o[0], c[0]) }, { i: 3, x: gr(o[1], c[1]) }))
				: c[0] || c[1]
				? r.push("translate(" + c + ")")
				: r.push(""),
			l != f
			...
			s != h
				? u.push({ i: r.push(r.pop() + "skewX(", null, ")") - 2, x: gr(s, h) })
	...
	function hu(n, t) {
		var e = n.children;
		if (e && (u = e.length))
			for (var r, u, i = -1; ++i < u; ) t((r = hu(e[i], t)), n) > 0 && (n = r);
		return n;
	}
	function gu(n, t) {
		return n.x - t.x;
		...
		if ((e = n.children) && (l = e.length)) {
			...
			if (
				...
				for (
					...
					p
						? (m > d || (d == m && u.r < r.r) ? _u(r, (u = o)) : _u((r = c), u),
						  a--)
						: (bu(r, i), (u = i), t(i));
				}
			var v = (f + s) / 2,
	...
	function Xu(n, t, e) {
		...
		return ca.format(
			e
				? e.replace(uo, function (n, t, e, u, i, a, o, c, l, f) {
						return [
							t,
							e,
							u,
	...
	function fi(n) {
		...
		return (
			...
			(t.interpolate = function (n) {
				return arguments.length
					? ((c = "function" == typeof n ? (o = n) : (o = jo.get(n) || Le).key),
					  (l = o.reverse || o),
					  (f = o.closed ? "M" : "L"),
					  t)
					: c;
	...
	(ca.ascending = function (n, t) {
		...
		(ca.median = function (t, e) {
			return (
				...
				(t = t.filter(n)),
				t.length ? ca.quantile(t.sort(ca.ascending), 0.5) : void 0
			);
		}),
		...
		(ca.behavior.drag = function () {
			...
			function t() {
				function n() {
					var n = a.parentNode;
					return null != f
						? ca.touches(n).filter(function (n) {
				...
				function t() {
					...
					(g |= e | r),
						(h = t),
						l(),
						o({ type: "drag", x: t[0] + i[0], y: t[1] + i[1], dx: e, dy: r });
				}
				function u() {
					o({ type: "dragend" }),
						g && (l(), ca.event.target === c && s(p, "click")),
						p
		...
		(ca.behavior.zoom = function () {
			...
			function a(n) {
				i(),
					...
					n({ type: "zoom", scale: S, translate: w });
			}
			function o() {
				function n() {
	...
	Ba.forEach(function (n, t) {
		...
		(ca.xhr = function (n, t, e) {
			...
			var u = {},
				...
				o = st,
				c = new (
					fa.XDomainRequest && /^(http(s)?:)?\/\//.test(n)
						? XDomainRequest
						: XMLHttpRequest
				)();
			return (
	...
	(ca.timer = function (n, t, e) {
		...
		r && r.callback === n
			? ((r.then = e), (r.delay = t))
			: (Ka[(n.id = ++Ga)] = Wa = { callback: n, then: e, delay: t, next: Wa }),
	...
	var Qa =
			fa.requestAnimationFrame ||
			fa.webkitRequestAnimationFrame ||
	...
	var uo =
		...
		io = ca.map({
			...
			r: function (n, t) {
				return (n = ca.round(n, vt(n, t))).toFixed(
					Math.max(0, Math.min(20, vt(n * (1 + 1e-15), t)))
				);
			},
		}),
		ao = st;
	...
	(ca.geo.projection = Wt),
		...
		(ca.geo.rotation = function (n) {
			...
			return (
				(n = ee((n[0] % 360) * Pa, n[1] * Pa, n.length > 2 ? n[2] * Pa : 0)),
				(t.invert = function (t) {
					return (
						(t = n.invert(t[0] * Pa, t[1] * Pa)), (t[0] *= Ra), (t[1] *= Ra), t
					);
				}),
				t
			);
				...
				(n.clip = function (t) {
					for (
						...
						for (
							...
							(o = e[r]),
								tr(o, f, i)
									? (tr(a, f, i) || t.push(er(a, o, f, i)), t.push(o))
									: tr(a, f, i) && t.push(er(a, o, f, i)),
								(a = o);
						f = i;
					}
					return t;
			...
			if (g > 0)
				for (i = -1; ++i < h; )
					(o = l[i]),
						o >= f[0] &&
							o <= f[1] &&
							((a = c[ca.bisect(s, o, 1, g) - 1]), (a.y += p), a.push(n[i]));
			return c;
		}
		var t = !0,
			e = Number,
					...
					if (t) {
						for (
							...
							(c = fu(c)),
								...
								u > 0 && (yu(Mu(o, n, r), n, u), (l += u), (f += u)),
								(s += o._tree.mod),
								(l += i._tree.mod),
								(h += c._tree.mod),
								(f += a._tree.mod);
						o && !su(a) && ((a._tree.thread = o), (a._tree.mod += s - f)),
							i &&
								!fu(c) &&
	...
	(ac.call = ka.call),
		...
		(ac.ease = function (n) {
			...
			return arguments.length < 1
				...
				: ("function" != typeof n && (n = ca.ease.apply(ca, arguments)),
				  j(this, function (e) {
	...
	ca.svg.brush = function () {
		function n(i) {
			i.each(function () {
				...
				a
					...
					h.exit().remove(),
					o &&
						((i = Fu(o)), l.attr("x", i[0]).attr("width", i[1] - i[0]), e(a)),
					c &&
						((i = Fu(c)), l.attr("y", i[0]).attr("height", i[1] - i[0]), r(a)),
					t(a);
			});
		}
		function t(n) {
		...
		function u() {
			...
			function f() {
				ca.event.keyCode == 32 &&
					(E || ((m = null), (k[0] -= s[1][0]), (k[1] -= s[1][1]), (E = 2)),
					l());
			}
			function h() {
				ca.event.keyCode == 32 &&
			...
			function g() {
				...
				v && ((n[0] += v[0]), (n[1] += v[1])),
					E ||
						(ca.event.altKey
							? (m || (m = [(s[0][0] + s[1][0]) / 2, (s[0][1] + s[1][1]) / 2]),
							  (k[0] = s[+(n[0] < m[0])][0]),
							  (k[1] = s[+(n[1] < m[1])][1]))
							: (m = null)),
					w && p(n, o, 0) && (e(b), (i = !0)),
		...
		pc.forEach(function (n, t) {
			...
			var e = (ca.time[n] = Ei(
				...
				function (n) {
					...
					return (
						Math.floor((ca.time.dayOfYear(n) + ((e + t) % 7)) / 7) - (e !== t)
					);
				}
			));
			(ca.time[n + "s"] = e.range),
			...
			function t(t) {
				for (var r, u, i, a = [], o = -1, c = 0; ++o < e; )
					n.charCodeAt(o) === 37 &&
						...
						(u = Nc[(r = n.charAt(++o))]) != null && (r = n.charAt(++o)),
